...
describe("splitCodeLines", () => {
	it("wraps each line in a numbered row with a text cell", () => {
		...
		expect(result.html).toBe(
			`<span class="xoji-code-line"><span class="xoji-code-line__text">a</span></span>` +
				`<span class="xoji-code-line"><span class="xoji-code-line__text">b</span></span>` +
				`<span class="xoji-code-line"><span class="xoji-code-line__text">c</span></span>`,
		);
	});
	...
	it("keeps an interior blank line as a zero-width-space row", () => {
		const result = splitCodeLines("a\n\nb");
		expect(result.lines).toBe(3);
		expect(result.html).toContain(`<span class="xoji-code-line__text">${ZWSP}</span>`);
	});
	...
	it("closes and re-opens a token span that straddles a newline", () => {
		...
		expect(result.html).toBe(
			`<span class="xoji-code-line"><span class="xoji-code-line__text">` +
	...
	it("tags only the 1-based lines in the highlight set", () => {
		...
		expect(result.html).toBe(
			`<span class="xoji-code-line"><span class="xoji-code-line__text">a</span></span>` +
				`<span class="xoji-code-line" data-line-highlight><span class="xoji-code-line__text">b</span></span>` +
				`<span class="xoji-code-line"><span class="xoji-code-line__text">c</span></span>`,
		);
	});
