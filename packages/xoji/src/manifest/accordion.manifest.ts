...
const htmlExample = `<xoji-accordion>
...
const multipleExample = `<xoji-accordion multiple size="sm">
...
export const accordionManifest: ComponentManifest = {
	...
	anatomy: [
		...
		},
		{
			...
			selector: ".xoji-accordion__trigger",
			tokens: [
				"--text-body",
				"--weight-medium",
				"--leading-tight",
		...
		},
		{
			...
			selector: ".xoji-accordion__chevron",
		...
		},
		{
			...
			selector: ".xoji-accordion__panel",
	...
	variants: [],
	sizes: [
		{ name: "sm", description: "Compact triggers.", className: "xoji-accordion--sm" },
		{ name: "md", description: "Default.", className: "xoji-accordion", isDefault: true },
		{ name: "lg", description: "Roomy triggers.", className: "xoji-accordion--lg" },
	],
	states: [
		{
			name: "open",
			description: "An expanded section: the trigger reads `aria-expanded=\"true\"` and the chevron rotates.",
			selector: ".xoji-accordion__trigger[aria-expanded=\"true\"]",
			tokens: [],
		},
		{
			name: "trigger-hover",
			description: "Pointer over a header: the hover tint paints behind it.",
			selector: ".xoji-accordion__trigger:hover",
			tokens: ["--state-hover"],
		},
		{
