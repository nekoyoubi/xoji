...
const htmlExample = `<xoji-checkbox name="terms" value="accepted">I accept the terms</xoji-checkbox>
...
const groupHtmlExample = `<xoji-checkbox-group label="Notifications">
...
export const checkboxManifest: ComponentManifest = {
	...
	anatomy: [
		...
		},
		{
			...
			selector: ".xoji-checkbox__control",
			tokens: [
				"--field-bg",
				"--field-border",
				"--border-thin",
		...
		},
		{
			...
			selector: ".xoji-checkbox__indicator",
			tokens: ["--accent-fg"],
		},
		{
			name: "label",
			description: "The text content wrapper beside the box.",
			selector: ".xoji-checkbox__label",
		},
	],
	props: [
		{
