...
const htmlExample = `<xoji-avatar alt="Ada Lovelace" src="/avatars/ada.jpg"></xoji-avatar>
	...
	variants: [
		{
			...
			className: "xoji-avatar",
			tokens: ["--radius-full"],
		},
		{
			name: "square",
			description: "A rounded square, for entities and projects rather than people.",
			className: "xoji-avatar--square",
			tokens: ["--radius-md", "--radius-sm", "--radius-lg"],
		},
	],
	sizes: [
		{ name: "sm", description: "Compact, for dense lists.", className: "xoji-avatar--sm" },
		{ name: "md", description: "Default.", className: "xoji-avatar", isDefault: true },
		{ name: "lg", description: "Large, for headers.", className: "xoji-avatar--lg" },
		{ name: "xl", description: "Extra large, for profile hero.", className: "xoji-avatar--xl" },
	],
	states: [
		{
			name: "fallback",
