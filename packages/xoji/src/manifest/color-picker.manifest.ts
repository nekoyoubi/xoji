...
const htmlExample = `<xoji-color-picker label="Brand color" value="#5b8cff"></xoji-color-picker>
...
export const colorPickerManifest: ComponentManifest = {
	...
	anatomy: [
		...
		},
		{
			...
			selector: ".xoji-color-picker__area",
		...
		},
		{
			...
			selector: ".xoji-color-picker__sv-handle",
		...
		},
		{
			...
			selector: ".xoji-color-picker__plane",
			tokens: ["--radius-md", "--border-thin", "--line-2"],
		},
		{
			name: "plane-handle",
			...
			selector: ".xoji-color-picker__plane-handle",
		...
		},
		{
			...
			selector: ".xoji-color-picker__alpha",
		...
		},
		{
			...
			selector: ".xoji-color-picker__format",
		...
		},
		{
			...
			selector: ".xoji-color-picker__value",
		...
		},
		{
			...
			selector: ".xoji-color-picker__eyedropper",
		...
		},
		{
			...
			selector: ".xoji-color-picker__preset",
		...
		},
		{
			...
			selector: ".xoji-color-picker__harmony",
		},
		{
			name: "channels",
			...
			selector: ".xoji-color-picker__channels",
		...
		},
		{
			...
			selector: ".xoji-color-picker__snaps",
		...
		},
		{
			...
			selector: ".xoji-color-picker__contrast",
		...
		},
		{
			...
			selector: ".xoji-color-picker__trigger",
		...
		},
		{
			...
			selector: ".xoji-color-picker__popover",
		...
		},
		{
			...
			selector: ".xoji-color-picker__label",
			tokens: ["--fg-1", "--text-sm"],
		},
	],
	props: [
	...
	states: [
		{
			...
			selector: ".xoji-color-picker__sv-handle:focus-visible, .xoji-color-picker__hue-handle:focus-visible, .xoji-color-picker__value:focus-visible",
			tokens: ["--border-normal", "--border-thick", "--ring"],
		},
		{
			name: "disabled",
			description: "Non-interactive: muted and pointer-events suppressed.",
			selector: ".xoji-color-picker--disabled",
			tokens: ["--fg-disabled"],
		},
	],
	slots: [],
