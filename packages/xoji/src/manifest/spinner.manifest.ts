...
const htmlExample = `<xoji-spinner aria-label="Loading"></xoji-spinner>
	...
	variants: [
		{
			...
			className: "xoji-spinner--accent",
			tokens: ["--accent"],
		},
		{
			name: "neutral",
			description: "Neutral-toned ring.",
			className: "xoji-spinner--neutral",
			tokens: ["--neutral"],
		},
		{
			name: "danger",
			description: "Danger-toned ring.",
			className: "xoji-spinner--danger",
			tokens: ["--danger"],
		},
		{
			name: "success",
			description: "Success-toned ring.",
			className: "xoji-spinner--success",
			tokens: ["--success"],
		},
		{
			name: "warn",
			description: "Warn-toned ring.",
			className: "xoji-spinner--warn",
			tokens: ["--warn"],
		},
		{
			name: "info",
			description: "Info-toned ring.",
			className: "xoji-spinner--info",
			tokens: ["--info"],
		},
	],
	sizes: [
		{ name: "sm", description: "Compact: thinner ring.", className: "xoji-spinner--sm" },
		{ name: "md", description: "Default.", className: "xoji-spinner", isDefault: true },
		{ name: "lg", description: "Large.", className: "xoji-spinner--lg" },
	],
	states: [],
	slots: [],
	consumedTokens: [
