...
export const segmentedManifest: ComponentManifest = {
	...
	props: [
		...
		{ name: "options", type: "string", description: "Comma-separated options: bare labels (`Day,Week`) or `label:value` pairs (`Left:start`).", bindings: ["html", "svelte", "astro"] },
