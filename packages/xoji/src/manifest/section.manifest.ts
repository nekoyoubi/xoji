...
const htmlExample = `<xoji-section tone="accent" bordered>
	<h2>A page band</h2>
...
export const sectionManifest: ComponentManifest = {
	...
	props: [
		...
		},
		{
			name: "label",
			type: "string",
			description: "A corner tag for a stage (e.g. a `live · @xoji/astro` provenance line).",
			bindings: ["html", "svelte", "astro"],
		},
	],
	variants: [
		...
		},
		{
			...
			className: "xoji-section--stage",
			tokens: ["--accent-bg", "--bg-2", "--radius-lg", "--elevation-3", "--ring-bg", "--border-thin", "--accent"],
		},
	],
	sizes: [
		{ name: "sm", description: "Tighter band padding.", className: "xoji-section--sm" },
		{ name: "md", description: "Medium band padding.", className: "xoji-section--md" },
		{ name: "lg", description: "Generous band padding (default).", className: "xoji-section", isDefault: true },
	],
	states: [],
	slots: [
		{
