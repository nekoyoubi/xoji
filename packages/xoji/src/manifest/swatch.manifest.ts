...
const htmlExample = `<xoji-swatch color="#ff0099" label="Hot pink" value="#ff0099"></xoji-swatch>
...
const htmlInteractiveExample = `<xoji-swatch color="#0ea5e9" label="Sky" interactive selected></xoji-swatch>
...
export const swatchManifest: ComponentManifest = {
	...
	variants: [],
	sizes: [
		{ name: "sm", description: "A compact chip for dense palette rails.", className: "xoji-swatch--sm" },
		{ name: "md", description: "The default chip, sized with body text.", className: "xoji-swatch", isDefault: true },
		{ name: "lg", description: "A prominent chip for a featured color.", className: "xoji-swatch--lg" },
	],
	states: [
		{
			name: "selected",
			description: "An interactive chip in its chosen state: the dot ringed in the accent, `aria-pressed` set.",
			selector: ".xoji-swatch--selected .xoji-swatch__dot",
			tokens: ["--border-thick", "--accent"],
		},
		{
			name: "focus-visible",
			description: "An interactive chip focused by keyboard; a ring picks it out for the next selection.",
			selector: ".xoji-swatch--interactive:focus-visible",
