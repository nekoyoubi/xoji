...
const htmlExample = `<xoji-form-group label="Theme" description="Applies across the whole workspace." for="theme">
...
export const formGroupManifest: ComponentManifest = {
	...
	anatomy: [
		...
		},
		{
			...
			selector: ".xoji-form-group__required",
	...
	variants: [
		{
			...
			className: "xoji-form-group",
		},
		{
			name: "invalid",
			description: "The error message is shown, the label takes the danger ink, and the control is marked `aria-invalid`.",
			className: "xoji-form-group--invalid",
			tokens: ["--danger-text", "--danger"],
		},
	],
	sizes: [
		{ name: "sm", description: "Compact stack and smaller helper text.", className: "xoji-form-group--sm" },
		{ name: "md", description: "Default.", className: "xoji-form-group", isDefault: true },
		{ name: "lg", description: "Roomier stack and larger helper text.", className: "xoji-form-group--lg" },
	],
	states: [
		{
			name: "invalid",
			description: "Error region revealed, label tinted danger, control flagged `aria-invalid`.",
			selector: ".xoji-form-group--invalid",
			tokens: ["--danger-text"],
		},
		{
			name: "required",
