...
const htmlExample = `<xoji-number-input label="Quantity" value="1" min="0" max="99"></xoji-number-input>
...
const altHtmlExample = `<xoji-number-input label="Volume" value="50" min="0" max="100" alt-step="10"></xoji-number-input>
...
export const numberInputManifest: ComponentManifest = {
	...
	props: [
		...
		{ name: "step", type: "number", default: "1", description: "Granularity for the buttons and arrow keys; values snap to it. Use `0.01` for currency.", bindings: ["html", "svelte", "astro"] },
