...
const htmlExample = `<xoji-radio-group label="Plan" orientation="vertical">
...
export const radioManifest: ComponentManifest = {
	...
	states: [
		...
		},
		{
			...
			selector: ".xoji-radio__control:focus-visible ~ .xoji-radio__indicator",
			tokens: ["--border-normal", "--border-thick", "--ring"],
		},
		{
			name: "invalid",
			description: "Marked invalid: the indicator border turns danger-colored.",
			selector: ".xoji-radio--invalid .xoji-radio__indicator",
			tokens: ["--danger"],
		},
		{
			name: "disabled",
			description: "Non-interactive: muted fill and ink, no pointer.",
			selector: '.xoji-radio__control:disabled ~ .xoji-radio__indicator, .xoji-radio[aria-disabled="true"]',
