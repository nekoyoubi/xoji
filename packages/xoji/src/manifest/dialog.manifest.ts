...
const htmlExample = `<xoji-button variant="solid" tone="accent" onclick="document.getElementById('confirm').showModal()">
	Delete account
</xoji-button>
...
export const dialogManifest: ComponentManifest = {
	...
	variants: [],
	sizes: [
		{ name: "sm", description: "Compact: for short confirmations.", className: "xoji-dialog--sm" },
		{ name: "md", description: "Default.", className: "xoji-dialog", isDefault: true },
		{ name: "lg", description: "Roomy: for richer content.", className: "xoji-dialog--lg" },
	],
	states: [
		{
			name: "open",
		...
		},
		{
			...
			selector: ".xoji-dialog__close:focus-visible",
