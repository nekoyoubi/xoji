...
const htmlExample = `<xoji-statusbar label="Editor status">
...
export const statusbarManifest: ComponentManifest = {
	...
	anatomy: [
		...
		},
		{
			...
			selector: ".xoji-statusbar__overflow",
			tokens: [
				"--space-1",
				"--space-2",
				"--space-8",
	...
	variants: [
		{
			...
			className: "xoji-statusbar__item--strong",
	...
	states: [
		{
			...
			selector: ".xoji-statusbar__item:focus-visible",
