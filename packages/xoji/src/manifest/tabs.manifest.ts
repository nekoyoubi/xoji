...
const htmlExample = `<xoji-tabs variant="underline" label="Account settings" value="profile">
...
export const tabsManifest: ComponentManifest = {
	...
	variants: [
		...
		},
		{
			...
			className: "xoji-tabs--enclosed",
			tokens: ["--bg-1", "--line", "--accent-text"],
		},
	],
	sizes: [
		{ name: "sm", description: "Compact.", className: "xoji-tabs--sm" },
		{ name: "md", description: "Default.", className: "xoji-tabs", isDefault: true },
	],
	states: [
		{
			name: "selected",
			...
			selector: '.xoji-tabs__tab[aria-selected="true"]',
		...
		},
		{
			...
			selector: ".xoji-tabs__tab:focus-visible",
		...
		},
		{
			...
			selector: '.xoji-tabs__tab:disabled, .xoji-tabs__tab[aria-disabled="true"]',
			tokens: ["--fg-disabled"],
		},
	],
	slots: [
