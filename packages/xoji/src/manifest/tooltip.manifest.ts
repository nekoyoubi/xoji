...
const htmlExample = `<xoji-tooltip text="Save your changes" placement="top">
...
export const tooltipManifest: ComponentManifest = {
	...
	anatomy: [
		...
		},
		{
			...
			selector: ".xoji-tooltip__content::before",
