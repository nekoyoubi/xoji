...
const htmlExample = `<xoji-toolbar heading="Project Atlas" landmark>
	...
	variants: [
		{
			...
			className: "xoji-toolbar--bare",
		},
		{
			name: "sticky",
			description: "Pinned to the top of its scroll area at an elevated stacking layer.",
			className: "xoji-toolbar--sticky",
			tokens: ["--elevation-3"],
		},
	],
	sizes: [
		{ name: "sm", description: "Tight, compact density.", className: "xoji-toolbar--sm" },
		{ name: "md", description: "Default.", className: "xoji-toolbar", isDefault: true },
		{ name: "lg", description: "Roomy, generous padding.", className: "xoji-toolbar--lg" },
	],
	states: [
		{
			name: "title-hover",
			description: "Pointer over a linked title. The title shifts to the link-hover ink.",
			selector: "a.xoji-toolbar__title:hover",
			tokens: ["--link-hover"],
		},
		{
			...
			selector: "a.xoji-toolbar__title:focus-visible",
