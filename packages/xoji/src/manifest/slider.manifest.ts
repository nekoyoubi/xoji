...
const htmlExample = `<xoji-slider label="Volume" value="60"></xoji-slider>
...
export const sliderManifest: ComponentManifest = {
	...
	variants: [],
	sizes: [
		{ name: "sm", description: "Compact: thin rail, small thumb.", className: "xoji-slider--sm" },
		{ name: "md", description: "Default.", className: "xoji-slider", isDefault: true },
		{ name: "lg", description: "Large: thicker rail, bigger thumb for touch.", className: "xoji-slider--lg" },
	],
	states: [
		{
			name: "hover",
			description: "Pointer over the thumb. Overlay paints the hover tint.",
			selector: ".xoji-slider__thumb:hover::after",
			tokens: ["--state-hover"],
		},
		{
			name: "active",
			description: "Thumb pressed or dragging. Overlay paints the press tint.",
			selector: ".xoji-slider__thumb:active::after",
			tokens: ["--state-press"],
		},
		{
			name: "focus-visible",
