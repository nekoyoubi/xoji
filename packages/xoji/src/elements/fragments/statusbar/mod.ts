...
function overflowMenu(b: StatusbarBindings): string {
	...
	return (
		`<span class="xoji-statusbar__overflow" part="overflow" style="display:none">` +
		`<button class="xoji-statusbar__item xoji-statusbar__overflow-trigger" part="overflow-trigger" type="button" ` +
		`popovertarget="${popoverId}" aria-label="Show hidden status items">+0</button>` +
		`<div class="xoji-statusbar__overflow-popover" part="overflow-popover" id="${popoverId}" popover ` +
