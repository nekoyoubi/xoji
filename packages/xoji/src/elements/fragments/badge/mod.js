"use strict";
(() => {
  // packages/xoji/src/elements/fragments/badge/mod.ts
  var STATUS_WORD = {
    success: "Success",
    warn: "Warning",
    danger: "Danger",
  ...
  function badgeHtml(b) {
    ...
    const remove = b.removable ? `<button type="button" class="xoji-badge__remove" part="remove" aria-label="${removeLabel}">${REMOVE_ICON}</button>` : "";
