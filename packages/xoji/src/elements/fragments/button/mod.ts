...
function inner(b: ButtonBindings): string {
	...
	return (
		'<span class="xoji-button__icon" part="icon-start"><slot name="icon-start"></slot></span>' +
		'<span class="xoji-button__label" part="label"><slot></slot></span>' +
		'<span class="xoji-button__icon" part="icon-end"><slot name="icon-end"></slot></span>' +
		spinner
	);
}
