...
const EXTERNAL_ICON =
	'<svg class="xoji-link__external-icon" part="external-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 3h7v7"/><path d="M10 14 21 3"/><path d="M19 14v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h6"/></svg>';
...
function linkHtml(b: LinkBindings): string {
	...
	const newTabHint = external
		? '<span class="xoji-link__sr-only" part="sr-hint"> (opens in a new tab)</span>'
		: "";
