"use strict";
(() => {
  // packages/xoji/src/elements/fragments/alert/mod.ts
  var TONE_ICONS = {
  ...
  function alertClass(b) {
    ...
    const noIcon = severityOf(b) ? "" : " xoji-alert--noicon";
    return `xoji-alert xoji-alert--${variant} xoji-alert--${color || "info"}${noIcon}`;
  }
  function iconSvg(b) {
  ...
  function dismissButton(b) {
    ...
    return `<button class="xoji-alert__dismiss" part="dismiss" type="button" aria-label="${label}"><svg viewBox="0 0 24 24" width="1em" height="1em" aria-hidden="true"><path fill="currentColor" d="m12 10.6 5-5 1.4 1.4-5 5 5 5L17 18.4l-5-5-5 5L5.6 17l5-5-5-5L7 5.6l5 5Z"/></svg></button>`;
  }
  function role(b) {
