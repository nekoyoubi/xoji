(() => {
  ...
  // algorithms/xoji-hc/src/preset.ts
  var spec = {
    id: "xoji-hc",
    contrast: { floor: 7, textOnFill: 7 },
    vibrancy: 1,
    chroma: { accent: 1.8, status: 1.7, palette: 1.7, neutral: 5e-3, accentTint: 0.6 },
    elevation: { alphaBoost: 0.05 },
    extreme: true
  };

  // algorithms/xoji-hc/src/mod.ts
